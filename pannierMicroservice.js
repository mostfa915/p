// pannierMicroservice.js
const grpc = require('@grpc/grpc-js');
const protoLoader = require('@grpc/proto-loader');
// Charger le fichier pannier.proto
...
const pannierService = {
getpannier: (call, callback) => {
...
server.addService(pannierProto.pannierService.service, pannierService);
const port = 50052;
